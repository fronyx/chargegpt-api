import { FilterConfig, LocationFilter, ResponseStructure } from '../../index';
import { SupportContact } from './support-contact.interface';

/**
 * @deprecated This method is deprecated in favor of the {@link /Users/hidayathalim/Developments/fronyx/apps/libs/toolkit/src/lib/models/toolkit-project.model.ts} method.
 */
export class ToolkitProject implements Readonly<ToolkitProject> {
  ...
  api_token: string;
  is_active: boolean;
  data_source: 'FRK' | 'MUV' | 'NeutralPartner' | 'TEST';
  queue: string;
  name: string;
  ...
  constructor(args: {
    ...
    // this.data_source = 'NeutralPartner'; // TODO temporary fix
  }
